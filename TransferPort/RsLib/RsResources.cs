...
namespace RsLib
{
    ...
    public class RsResources
    {
        ...
        private static Dictionary<ResourcesKey, Object> container = new();
        private static Dictionary<string, MulticastDelegate> loadTask = new();
        private static List<AssetBundle> assetBundles = new();
        private static List<SpriteAtlas> spriteAtlases = new();
