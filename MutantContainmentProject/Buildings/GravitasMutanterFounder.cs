    ...
    public class Def : BaseDef
    {
        ...
        */
        public Dictionary<Tag, Dictionary<Tag, int>> sacrificeRecipes = new Dictionary<Tag, Dictionary<Tag, int>> {
            ...
            {
                SCP4762Config.ID, new Dictionary<Tag, int>
                {
                    { IceBellyConfig.ID, 2},
                    { GlomConfig.ID, 1}
                }
            ...
            {
                BugDuskConfig.ID, new Dictionary<Tag, int>
                {
                    { CrabConfig.ID, 2},
                    { HatchConfig.ID, 1}
                }
            ...
            {
                CosmicBugConfig.ID, new Dictionary<Tag, int>
                {
                    { GlomConfig.ID, 1},
                    { ButterflyConfig.ID, 2}
                }
            ...
            {
                CircusJokerConfig.ID, new Dictionary<Tag, int>
                {
                    { HatchConfig.ID, 2},
                    { ButterflyConfig.ID, 1}
                }
            }
        };
