...
{
    public class TbbSideScreen : TbbModule<TbbSideScreen>
    {
        protected List<ItemInfo> itemInfos = new();

        public TbbSideScreen CopyAndCreate<TSourceScreen, TNewScreen>()
            where TSourceScreen : SideScreenContent
            where TNewScreen : TbbSideScreenContent
        {
        ...
        public TbbSideScreen Create<TScreen>(SidescreenTabTypes tab)
        ...
        public TbbSideScreen Add(Func<SideScreenContent> add, bool isPrefab)
        {
            ItemInfo info = new ItemInfo();
            info.add = add;
        ...
        public TbbSideScreen Add(SideScreenContent prefab)
        {
            ItemInfo info = new ItemInfo();
            info.prefab = prefab;
            info.isPrefab = true;
        ...
        protected override void Initialized()
        {
            Harmony.Patch(
                ...
                "OnPrefabInit",
                null,
                new HarmonyMethod(typeof(TbbSideScreen), nameof(DetailsScreen_OnPrefabInit_Patch))
            );
        }
        ...
        public static TbbSideScreenContent CreateSideScreen(
        ...
        private static TbbSideScreenContent CopySideScreen(SideScreenContent sourceScreen, Type newScreen)
        {
            ...
            var newScreen2 = (TbbSideScreenContent)gameObject.AddComponent(newScreen);
