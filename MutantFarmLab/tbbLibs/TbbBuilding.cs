...
{
    public class TbbBuilding : TbbModule<TbbBuilding>
    {
        ...
        protected override void Initialized()
        {
            Harmony.Patch(typeof(Db), "Initialize",
                postfix: new HarmonyMethod(typeof(TbbBuilding), nameof(Db_Initialize_Postfix)));
        }


        private List<BuildingInfo> planScreenInfos = new();

        public TbbBuilding RegisterPlanScreen(string buildingID, HashedString category, string subcategoryID)
        {
            RegisterPlanScreenAndTech(buildingID, category, subcategoryID, null);
            return this;
        }

        public TbbBuilding RegisterPlanScreenAndTech(string buildingID, HashedString category, string subcategoryID, string techID)
        {
            planScreenInfos.Add(new BuildingInfo(buildingID, category, subcategoryID, techID));
            return this;
        }

        public TbbBuilding RegisterTech(string buildingID, string techID)
        {
        ...
        {
            private TbbBuilding rsBuilding;
            ...
            public Advanced(TbbBuilding rsBuilding)
            {
